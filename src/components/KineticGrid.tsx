...
type GridColor = 'default' | 'monochrome' | 'brand'
...
const THEMES = {
  ...
  // On-Brand: Pflaumen-Gitter, Bernstein-Glühen auf warmem Nacht-Schwarz
  brand: {
    bg: '#141019',
    lineActive: { r: 189, g: 169, b: 226, a: 0.9 },
    nodeActive: { r: 248, g: 172, b: 109, a: 1.0 },
    glow: '240,130,60',
    ripple: '189,169,226',
  },
} as const
...
export default function KineticGrid({
  ...
  useEffect(() => {
    ...
    // Barrierefreiheit: bei "reduzierte Bewegung" nur ein statisches Bild
